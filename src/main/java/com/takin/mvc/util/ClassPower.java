...
//        Preconditions.checkNotNull(obj, "object不能为空");
//        Preconditions.checkState(StringUtil.isNotNullOrEmpty(fieldName), "fieldName");
...
//        if (obj == null) {
//            throw new NestRuntimeException("object不能为空");
//        }
//
//        for (Class<?> superClass = obj.getClass(); superClass != Object.class; superClass = superClass.getSuperclass()) {
//            try {
