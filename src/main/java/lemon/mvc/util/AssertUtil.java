...
import lemon.mvc.mvc.exception.AssertException;
    ...
    */
    ...
    public static void isInstanceOf(Class type, Object obj, String message) {
        ...
        if (!type.isInstance(obj)) {
            throw new AssertException(message + "Object of class [" + (obj != null ? obj.getClass().getName() : "null") + "] must be an instance of " + type);
        }
    }
