...
import lemon.mvc.mvc.ReverseProxy;
...
public interface ClientContext {
     ...
     * @return cookies
     */
    lemon.mvc.mvc.client.CookieHandler getCookies();
    ...
    public static class DefaultClientContext implements ClientContext {
        ...
        @Override
        public lemon.mvc.mvc.client.CookieHandler getCookies() {
            if (cookies != null)
                return cookies;

            return cookies = GuiceDI.getInstance(lemon.mvc.mvc.client.CookieHandler.class);
