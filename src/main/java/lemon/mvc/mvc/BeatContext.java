...
public interface BeatContext {
    ...
    public class Model implements lemon.mvc.mvc.Model {

        /** Model Map */
        @Inject
        private lemon.mvc.mvc.Model model;
         ...
         */
        @Deprecated
        public lemon.mvc.mvc.Model addAttribute(Object attributeValue) {
         ...
         * @param attributeValue 属性值
         */
        public lemon.mvc.mvc.Model add(Object attributeValue) {
         ...
         */
        @Deprecated
        public lemon.mvc.mvc.Model addAttribute(String attributeName, Object attributeValue) {
         ...
         * @param attributeValue 属性值
         */
        public lemon.mvc.mvc.Model add(String attributeName, Object attributeValue) {
         ...
         */
        @Deprecated
        public lemon.mvc.mvc.Model addAllAttributes(Map<String, ?> attributes) {
         ...
         * @param attributes
         */
        public lemon.mvc.mvc.Model addAll(Map<String, ?> attributes) {
         ...
         * @param attributes
         */
        public lemon.mvc.mvc.Model merge(Map<String, ?> attributes) {
